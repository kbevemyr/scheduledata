...
public class TimeScheduleEvent implements Comparable<TimeScheduleEvent>{
    ...
    public TimeScheduleEvent (String d, String st, String k, String g, String dt, String a) {
...
//{"id": "100", "day": "1", arena: "kula", "starttime": 0, "duration": 15, "class": "M", "gren": "400m fö"}
  return START+"id: "+q(klass+gren)+SEP+"day: "+q(day)+SEP+"arena: "+q(arena)+SEP+"starttime: "+q(stm)+SEP+"duration: "+Q+duration+Q+SEP+"class: "+q(klass)+SEP+"gren: "+q(gren)+END;
	...
	TimeScheduleEvent e = new TimeScheduleEvent("Lördag", "12:20", "F15", "Kula", "33 min", "Kula/Vikt");
